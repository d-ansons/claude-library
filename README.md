...
| [case-study](plugins/case-study) | Builds a work project case study through an interview loop that drafts a file live, tracks open questions in a Follow-up Questions checklist, probes for tool-specific depth, and fills a career timeline, a reflection questioning specific choices against their alternatives, ratings, CV bullet points, a STAR interview story with sample Q&A, and tags. |
